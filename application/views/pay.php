...
?>
    <div class="cart-container">
            ...
            <div class="cart-item">
                <div class="cart-item-left">
                    <div class="product-info">
                        <h2 class="product-brand" style="width: 500px; margin-left:1rem;"><?= $aa['belanja'] ?></h2>
                    </div>
                </div>
                <div class="cart-item-right">
                    <span class="product-price">Rp<?= number_format($aa['total'],0,',','.   ') ?></span>
        ...
        <div class="cart-summary">
            <div class="btn btn-<?= $aa['status'] == 'Tertunda' ? 'danger' : 'success' ?>"><?= $aa['status'] ?></div>
        </div>
    </div>
    <div>
    </div>
